...
class BadRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, message, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            name (str): The error name. defaults to "BAD_REQUEST"  # noqa: E501
            status (float): The status code of the exception. defaults to 400  # noqa: E501
        ...
        name = kwargs.get('name', "BAD_REQUEST")

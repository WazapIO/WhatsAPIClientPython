...
class NotFound(ModelNormal):
    ...
    def _from_openapi_data(cls, message, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            name (str): The error name. defaults to "NOT_FOUND"  # noqa: E501
            status (float): The status code of the exception. defaults to 404  # noqa: E501
        ...
        name = kwargs.get('name', "NOT_FOUND")
